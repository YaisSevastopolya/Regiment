...
class DeputyCompanyLeader (
    override val position: String = "deputyCompanyLeader",
    ...
    override val basicCombatPower = (Data.database["deputyCompanyLeader"] ?: error("")).basicCombatPower
}