...
class MotorizedCompanyLeader (
override val position: String = "motorizedCompanyLeader",
...
override var commandCombatExperience: Percent = Percent(0),
    ...
    override val basicCombatPower = (Data.database["motorizedCompanyLeader"] ?: error("")).basicCombatPower
}