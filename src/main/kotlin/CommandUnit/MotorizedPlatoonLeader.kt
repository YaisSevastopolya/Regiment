...
class MotorizedPlatoonLeader (
    override val position: String = "motorizedPlatoonLeader",
    ...
    override val basicCombatPower = (Data.database["motorizedPlatoonLeader"] ?: error("")).basicCombatPower
}