...
class MotorizedRegimentLeader (
    override val position: String = "motorizedRegimentLeader",
    ...
    override val basicCombatPower = (Data.database["motorizedRegimentLeader"] ?: error("")).basicCombatPower
}