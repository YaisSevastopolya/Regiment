...
class MotorizedSquadLeader (
    override val position: String = "motorizedSquadLeader",
    ...
    override val basicCombatPower = (Data.database["motorizedSquadLeader"] ?: error("")).basicCombatPower
}