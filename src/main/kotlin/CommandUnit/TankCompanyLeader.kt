...
class TankCompanyLeader (
    override val position: String = "tankCompanyLeader",
    ...
    override val basicCombatPower = (Data.database["tankCompanyLeader"] ?: error("")).basicCombatPower
}