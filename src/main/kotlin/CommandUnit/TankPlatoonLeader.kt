...
class TankPlatoonLeader (
    override val position: String = "tankPlatoonLeader",
    ...
    override val basicCombatPower = (Data.database["tankPlatoonLeader"] ?: error("")).basicCombatPower
}