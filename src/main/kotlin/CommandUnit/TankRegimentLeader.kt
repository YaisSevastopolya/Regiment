...
class TankRegimentLeader (
    override val position: String = "tankRegimentLeader",
    ...
    override val basicCombatPower = (Data.database["tankRegimentLeader"] ?: error("")).basicCombatPower
}